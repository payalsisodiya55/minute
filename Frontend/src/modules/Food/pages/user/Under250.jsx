                              ...
                              {quantity > 0 ? (
                                ...
                                >
                                  ...
                                  <button
                                    ...
                                    className="text-[#ff5722] hover:text-[#e64a19] p-0.5"
                                  >
                                ...
                                <button
                                  ...
                                  className={`absolute bottom-2 right-2.5 z-20 h-7 w-7 sm:h-8 sm:w-8 rounded-full bg-white dark:bg-gray-800 shadow-[0_4px_12px_rgba(0,0,0,0.15)] flex items-center justify-center text-[#ff5722] hover:scale-105 transition-transform duration-200 border border-gray-100 dark:border-gray-700 ${
                                ...
                                >
                                  <Plus className="h-4 w-4 sm:h-5 sm:w-5 text-[#ff5722]" strokeWidth={3} />
                                </button>
                              )}
                            </div>
